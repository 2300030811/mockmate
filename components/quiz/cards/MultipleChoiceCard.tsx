...
export const MultipleChoiceCard = memo(({
    ...
    return (
        ...
        bg-white/5 dark:bg-white/5 border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none
      `}>
                <div className="mb-8">
                    <h3 className="text-xl md:text-2xl font-bold mb-6 leading-relaxed whitespace-pre-wrap text-gray-900 dark:text-white">
                        {question.question}
                    </h3>
                    ...
                    <div className="mt-8">
                        ...
                        <AnimatePresence>
                            {showExplanation && (
                                ...
                                >
                                    <div
                                        className="mt-4 p-6 rounded-3xl border-2 bg-blue-50 dark:bg-blue-600/10 border-blue-100 dark:border-blue-500/20 dark:shadow-xl"
                                    >
