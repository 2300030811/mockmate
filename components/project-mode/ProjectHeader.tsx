...
import { CheckCircle, Sun, Moon, RotateCcw, Home } from "lucide-react";
...
export function ProjectHeader({ 
  ...
  const handleReset = () => {
    if (confirm("Reset all code to start?")) {
        setIsResetting(true);
        ...
        <div className="ml-1">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <span className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${
                ...
                project.difficulty === 'Medium' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' :
