...
import { Lightbulb, ChevronDown, ChevronUp, ExternalLink, Code2 } from "lucide-react";
...
export function SuccessModal({ isOpen, onClose, project, stats }: SuccessModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
          ...
          >
            <div className="text-center">
                ...
                <h2 className="text-4xl font-black mb-3 text-gray-900 dark:text-white tracking-tight">Challenge Solved!</h2>
                <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-sm mx-auto leading-relaxed">
                Excellent work fixing <span className="text-blue-600 dark:text-blue-400 font-black">&quot;{project.title}&quot;</span>. Your engineering intuition is sharp!
                </p>
                ...
                {stats && (
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <div className="p-5 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-gray-800 transition-colors group hover:bg-white dark:hover:bg-white/10">
                            <div className="text-[10px] uppercase tracking-[0.2em] text-gray-400 mb-2 font-black">Time Taken</div>
                            <div className="text-2xl font-black text-blue-600 dark:text-blue-400">{formatTime(stats.timeTaken)}</div>
                        </div>
                        <div className="p-5 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-gray-800 transition-colors group hover:bg-white dark:hover:bg-white/10">
                            <div className="text-[10px] uppercase tracking-[0.2em] text-gray-400 mb-2 font-black">Hints Used</div>
                            <div className="text-2xl font-black text-purple-600 dark:text-purple-400">{stats.hintsUsed}/{project.hints?.length || 0}</div>
                        </div>
                    </div>
                )}
            </div>
