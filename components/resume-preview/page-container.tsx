...
import { PAGE_DIMENSIONS, mmToPx } from './page-dimensions';
...
export function PageContainer({
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div
        className="relative bg-white border border-gray-200 dark:border-gray-700 shadow-xl origin-top"
        style={{
          width: pageWidthPx,
          height: pageHeightPx,
        ...
        {showMarginGuides && (
          <div
            ...
            style={{
              ...
              border: '1px dashed rgba(6, 182, 212, 0.5)', // cyan-500
            }}
          >
            {/* Corner markers */}
