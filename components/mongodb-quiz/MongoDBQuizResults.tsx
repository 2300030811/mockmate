...
export function MongoDBQuizResults({ report, onRetake, mode, questions, userAnswers, checkAnswer }: MongoDBQuizResultsProps) {
        ...
        return (
            <motion.div 
                ...
                className={`min-h-screen transition-colors duration-500 py-12 px-4 ${
                    isDark 
                      ? 'bg-gradient-to-br from-gray-950 via-gray-900 to-green-950 text-white' 
                      : 'bg-gradient-to-br from-gray-50 via-white to-green-50 text-gray-900'
                  }`}
            >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-bold transition-all ${
                                reviewIndex === questions.length - 1 
                                    ? 'opacity-30 cursor-not-allowed' 
                                    : isDark ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-green-600 hover:bg-green-700 text-white shadow-lg shadow-green-500/30'
                            }`}
                        >
                            Next
