...
import { MongoDBQuestionCard } from "./MongoDBQuestionCard";
import { MongoDBQuizResults } from "./MongoDBQuizResults";
...
export function MongoDBQuizShell({ mode }: MongoDBQuizShellProps) {
  ...
  const {
      ...
      calculateScore,
      checkAnswer
  } = useMongoDBQuiz({ initialMode: mode, countParam });
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex-1 mr-4">
                ...
                <div className={`w-full h-2.5 rounded-full ${
                  ...
                  <div 
                    className="bg-gradient-to-r from-green-600 to-teal-600 h-2.5 rounded-full transition-all duration-300" 
            ...
            <div className="flex justify-between items-center mt-8">
              ...
              {currentQuestionIndex < questions.length - 1 ? (
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 border-none text-white shadow-lg shadow-green-600/20"
                >
                  Finish & Submit
                </Button>
              )}
