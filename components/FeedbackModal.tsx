            ...
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-3.5 pl-4 rounded-xl border-2 outline-none transition-all text-sm focus-visible:ring-4 focus-visible:ring-sky-500/20 bg-gray-50 dark:bg-black/40 border-gray-100 dark:border-white/5 focus:border-sky-500 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-white/20"
                    />
                  </div>
                </div>
              )}
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  className={`w-full gap-2 h-12 rounded-xl transition-all font-bold uppercase tracking-widest text-[10px] ${message.length >= 5
