...
export function ModeCard({
  ...
  return (
    <button onClick={onClick} className="group relative w-full text-left h-full">
      <div className="relative p-8 rounded-3xl transition-all duration-300 overflow-hidden bg-white hover:bg-gray-50 border border-gray-200 shadow-lg dark:bg-gray-900/50 dark:hover:bg-gray-900/70 dark:border-gray-800 hover:scale-105 hover:shadow-2xl h-full flex flex-col">
        {/* Gradient Overlay */}
