...
import { RotateCcw, Home, FileText } from 'lucide-react';

export default function ResumeRoasterError({
    error,
    reset,
}: {
    ...
    useEffect(() => {
        console.error('[Resume Roaster Error]', error);
    }, [error]);
            ...
            <div className="p-8 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border border-gray-200/30 dark:border-white/10 shadow-xl max-w-md w-full">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm leading-relaxed">
                    {process.env.NODE_ENV === "development"
                        ? error.message
                        : "We hit a snag analyzing your resume. Even AI roasters get confused sometimes."}
                </p>
