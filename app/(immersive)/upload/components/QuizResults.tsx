        ...
        >
          ...
          <div className="text-center mb-8">
            <motion.div 
               ...
               className={`inline-flex items-center gap-3 px-6 py-3 rounded-full border shadow-lg ${
              passed
                ? isDark 
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-center mb-12">
            <motion.div 
              ...
              isDark ? 'bg-gray-800/40 border-gray-700' : 'bg-gray-50 border-gray-100'
            }`}>
            ...
            <motion.div 
              whileHover={{ scale: 1.05 }}
              className={`p-6 rounded-3xl border col-span-2 md:col-span-1 flex flex-col justify-center relative overflow-hidden ${
              isDark ? 'bg-gray-800/40 border-gray-700' : 'bg-gray-50 border-gray-100'
            }`}>
